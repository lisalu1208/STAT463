...
```
Several models were fitted and compared in this section. From the comparison above, we can see that the model with **Trt**,**Farm**, and **Plot** as the predictor variables, and **Observer** as the random effect has the best fit. 
